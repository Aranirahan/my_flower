...
import com.example.aran.my_flower.controller.RestManager;
import com.example.aran.my_flower.model.adapter.FlowerAdapter;
import com.example.aran.my_flower.model.callback.FlowerFetchListener;
import com.example.aran.my_flower.model.database.FlowerDatabase;
import com.example.aran.my_flower.model.helper.Constants;
import com.example.aran.my_flower.model.helper.Utils;
...
public class MainActivity extends AppCompatActivity implements FlowerAdapter.FlowerClickListener, FlowerFetchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.aran.my_flower.R.layout.activity_main);
        configViews();
    ...
    private void configViews() {
        mReload = findViewById(com.example.aran.my_flower.R.id.reload);
        mRecyclerView = findViewById(com.example.aran.my_flower.R.id.recyclerView);
